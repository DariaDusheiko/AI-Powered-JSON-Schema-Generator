...
from backend.src.infrastructure.database.repositories.schema import SchemaRepository
...
class UnitOfWork(IUnitOfWork):
    ...
    async def __aenter__(self) -> "UnitOfWork":
        ...
        self.chat = ChatRepository(session=self.__session)
        self.schema = SchemaRepository(session=self.__session)
